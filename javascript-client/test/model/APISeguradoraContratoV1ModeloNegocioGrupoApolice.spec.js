...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('APISeguradoraContratoV1ModeloNegocioGrupoApolice', function() {
      beforeEach(function() {
        instance = new Apiseguradora.APISeguradoraContratoV1ModeloNegocioGrupoApolice();
      });

      it('should create an instance of APISeguradoraContratoV1ModeloNegocioGrupoApolice', function() {
        // TODO: update the code to test APISeguradoraContratoV1ModeloNegocioGrupoApolice
        expect(instance).to.be.a(Apiseguradora.APISeguradoraContratoV1ModeloNegocioGrupoApolice);
      });
