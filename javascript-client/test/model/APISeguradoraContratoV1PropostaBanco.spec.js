...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('APISeguradoraContratoV1PropostaBanco', function() {
      beforeEach(function() {
        instance = new Apiseguradora.APISeguradoraContratoV1PropostaBanco();
      });

      it('should create an instance of APISeguradoraContratoV1PropostaBanco', function() {
        // TODO: update the code to test APISeguradoraContratoV1PropostaBanco
        expect(instance).to.be.a(Apiseguradora.APISeguradoraContratoV1PropostaBanco);
      });
