...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('APISeguradoraContratoV1ModeloPropostaModeloPropostaReduzido', function() {
      beforeEach(function() {
        instance = new Apiseguradora.APISeguradoraContratoV1ModeloPropostaModeloPropostaReduzido();
      });

      it('should create an instance of APISeguradoraContratoV1ModeloPropostaModeloPropostaReduzido', function() {
        // TODO: update the code to test APISeguradoraContratoV1ModeloPropostaModeloPropostaReduzido
        expect(instance).to.be.a(Apiseguradora.APISeguradoraContratoV1ModeloPropostaModeloPropostaReduzido);
      });
      ...
      it('should have the property politicaAceitacao (base name: "politicaAceitacao")', function() {
        // TODO: update the code to test the property politicaAceitacao
        expect(instance).to.have.property('politicaAceitacao');
        // expect(instance.politicaAceitacao).to.be(expectedValueLiteral);
      });

      it('should have the property questionarios (base name: "questionarios")', function() {
        // TODO: update the code to test the property questionarios
        expect(instance).to.have.property('questionarios');
        // expect(instance.questionarios).to.be(expectedValueLiteral);
      });
