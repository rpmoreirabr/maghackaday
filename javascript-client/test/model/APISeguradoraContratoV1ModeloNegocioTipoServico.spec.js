...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('APISeguradoraContratoV1ModeloNegocioTipoServico', function() {
      beforeEach(function() {
        instance = new Apiseguradora.APISeguradoraContratoV1ModeloNegocioTipoServico();
      });

      it('should create an instance of APISeguradoraContratoV1ModeloNegocioTipoServico', function() {
        // TODO: update the code to test APISeguradoraContratoV1ModeloNegocioTipoServico
        expect(instance).to.be.a(Apiseguradora.APISeguradoraContratoV1ModeloNegocioTipoServico);
      });
