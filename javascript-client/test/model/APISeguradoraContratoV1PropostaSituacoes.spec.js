...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('APISeguradoraContratoV1PropostaSituacoes', function() {
      beforeEach(function() {
        instance = new Apiseguradora.APISeguradoraContratoV1PropostaSituacoes();
      });

      it('should create an instance of APISeguradoraContratoV1PropostaSituacoes', function() {
        // TODO: update the code to test APISeguradoraContratoV1PropostaSituacoes
        expect(instance).to.be.a(Apiseguradora.APISeguradoraContratoV1PropostaSituacoes);
      });
