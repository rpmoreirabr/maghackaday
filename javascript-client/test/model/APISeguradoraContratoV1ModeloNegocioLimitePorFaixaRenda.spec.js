...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('APISeguradoraContratoV1ModeloNegocioLimitePorFaixaRenda', function() {
      beforeEach(function() {
        instance = new Apiseguradora.APISeguradoraContratoV1ModeloNegocioLimitePorFaixaRenda();
      });

      it('should create an instance of APISeguradoraContratoV1ModeloNegocioLimitePorFaixaRenda', function() {
        // TODO: update the code to test APISeguradoraContratoV1ModeloNegocioLimitePorFaixaRenda
        expect(instance).to.be.a(Apiseguradora.APISeguradoraContratoV1ModeloNegocioLimitePorFaixaRenda);
      });
