...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('APISeguradoraHelperResultadoDaOperacaoRestAPISeguradoraContratoV1PropostaAgendamentoMedico', function() {
      beforeEach(function() {
        instance = new Apiseguradora.APISeguradoraHelperResultadoDaOperacaoRestAPISeguradoraContratoV1PropostaAgendamentoMedico();
      });

      it('should create an instance of APISeguradoraHelperResultadoDaOperacaoRestAPISeguradoraContratoV1PropostaAgendamentoMedico', function() {
        // TODO: update the code to test APISeguradoraHelperResultadoDaOperacaoRestAPISeguradoraContratoV1PropostaAgendamentoMedico
        expect(instance).to.be.a(Apiseguradora.APISeguradoraHelperResultadoDaOperacaoRestAPISeguradoraContratoV1PropostaAgendamentoMedico);
      });
