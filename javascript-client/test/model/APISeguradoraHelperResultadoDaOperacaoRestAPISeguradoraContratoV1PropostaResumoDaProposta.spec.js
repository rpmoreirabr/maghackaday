...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('APISeguradoraHelperResultadoDaOperacaoRestAPISeguradoraContratoV1PropostaResumoDaProposta', function() {
      beforeEach(function() {
        instance = new Apiseguradora.APISeguradoraHelperResultadoDaOperacaoRestAPISeguradoraContratoV1PropostaResumoDaProposta();
      });

      it('should create an instance of APISeguradoraHelperResultadoDaOperacaoRestAPISeguradoraContratoV1PropostaResumoDaProposta', function() {
        // TODO: update the code to test APISeguradoraHelperResultadoDaOperacaoRestAPISeguradoraContratoV1PropostaResumoDaProposta
        expect(instance).to.be.a(Apiseguradora.APISeguradoraHelperResultadoDaOperacaoRestAPISeguradoraContratoV1PropostaResumoDaProposta);
      });
