...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('APISeguradoraHelperResultadoDaOperacaoRestAPIInfraestruturaContratoV1DadosDominio', function() {
      beforeEach(function() {
        instance = new Apiseguradora.APISeguradoraHelperResultadoDaOperacaoRestAPIInfraestruturaContratoV1DadosDominio();
      });

      it('should create an instance of APISeguradoraHelperResultadoDaOperacaoRestAPIInfraestruturaContratoV1DadosDominio', function() {
        // TODO: update the code to test APISeguradoraHelperResultadoDaOperacaoRestAPIInfraestruturaContratoV1DadosDominio
        expect(instance).to.be.a(Apiseguradora.APISeguradoraHelperResultadoDaOperacaoRestAPIInfraestruturaContratoV1DadosDominio);
      });
