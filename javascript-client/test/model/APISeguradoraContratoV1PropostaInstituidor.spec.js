...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('APISeguradoraContratoV1PropostaInstituidor', function() {
      beforeEach(function() {
        instance = new Apiseguradora.APISeguradoraContratoV1PropostaInstituidor();
      });

      it('should create an instance of APISeguradoraContratoV1PropostaInstituidor', function() {
        // TODO: update the code to test APISeguradoraContratoV1PropostaInstituidor
        expect(instance).to.be.a(Apiseguradora.APISeguradoraContratoV1PropostaInstituidor);
      });
