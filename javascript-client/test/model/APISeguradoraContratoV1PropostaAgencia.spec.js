...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('APISeguradoraContratoV1PropostaAgencia', function() {
      beforeEach(function() {
        instance = new Apiseguradora.APISeguradoraContratoV1PropostaAgencia();
      });

      it('should create an instance of APISeguradoraContratoV1PropostaAgencia', function() {
        // TODO: update the code to test APISeguradoraContratoV1PropostaAgencia
        expect(instance).to.be.a(Apiseguradora.APISeguradoraContratoV1PropostaAgencia);
      });
