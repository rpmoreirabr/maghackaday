...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('APISeguradoraContratoV1ModeloNegocioTipoRenda', function() {
      beforeEach(function() {
        instance = new Apiseguradora.APISeguradoraContratoV1ModeloNegocioTipoRenda();
      });

      it('should create an instance of APISeguradoraContratoV1ModeloNegocioTipoRenda', function() {
        // TODO: update the code to test APISeguradoraContratoV1ModeloNegocioTipoRenda
        expect(instance).to.be.a(Apiseguradora.APISeguradoraContratoV1ModeloNegocioTipoRenda);
      });
