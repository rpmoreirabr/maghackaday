...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('APISeguradoraHelperResultadoDaOperacaoRestSystemBoolean', function() {
      beforeEach(function() {
        instance = new Apiseguradora.APISeguradoraHelperResultadoDaOperacaoRestSystemBoolean();
      });

      it('should create an instance of APISeguradoraHelperResultadoDaOperacaoRestSystemBoolean', function() {
        // TODO: update the code to test APISeguradoraHelperResultadoDaOperacaoRestSystemBoolean
        expect(instance).to.be.a(Apiseguradora.APISeguradoraHelperResultadoDaOperacaoRestSystemBoolean);
      });
