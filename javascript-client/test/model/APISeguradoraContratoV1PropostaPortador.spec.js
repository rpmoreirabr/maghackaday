...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('APISeguradoraContratoV1PropostaPortador', function() {
      beforeEach(function() {
        instance = new Apiseguradora.APISeguradoraContratoV1PropostaPortador();
      });

      it('should create an instance of APISeguradoraContratoV1PropostaPortador', function() {
        // TODO: update the code to test APISeguradoraContratoV1PropostaPortador
        expect(instance).to.be.a(Apiseguradora.APISeguradoraContratoV1PropostaPortador);
      });
