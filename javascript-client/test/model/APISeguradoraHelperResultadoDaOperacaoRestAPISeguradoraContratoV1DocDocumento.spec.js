...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('APISeguradoraHelperResultadoDaOperacaoRestAPISeguradoraContratoV1DocDocumento', function() {
      beforeEach(function() {
        instance = new Apiseguradora.APISeguradoraHelperResultadoDaOperacaoRestAPISeguradoraContratoV1DocDocumento();
      });

      it('should create an instance of APISeguradoraHelperResultadoDaOperacaoRestAPISeguradoraContratoV1DocDocumento', function() {
        // TODO: update the code to test APISeguradoraHelperResultadoDaOperacaoRestAPISeguradoraContratoV1DocDocumento
        expect(instance).to.be.a(Apiseguradora.APISeguradoraHelperResultadoDaOperacaoRestAPISeguradoraContratoV1DocDocumento);
      });
