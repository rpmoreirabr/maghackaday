...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('APISeguradoraHelperResultadoDaOperacaoRestSystemInt64', function() {
      beforeEach(function() {
        instance = new Apiseguradora.APISeguradoraHelperResultadoDaOperacaoRestSystemInt64();
      });

      it('should create an instance of APISeguradoraHelperResultadoDaOperacaoRestSystemInt64', function() {
        // TODO: update the code to test APISeguradoraHelperResultadoDaOperacaoRestSystemInt64
        expect(instance).to.be.a(Apiseguradora.APISeguradoraHelperResultadoDaOperacaoRestSystemInt64);
      });
