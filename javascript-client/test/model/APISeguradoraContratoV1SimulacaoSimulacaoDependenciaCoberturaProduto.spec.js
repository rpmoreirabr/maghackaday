...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('APISeguradoraContratoV1SimulacaoSimulacaoDependenciaCoberturaProduto', function() {
      beforeEach(function() {
        instance = new Apiseguradora.APISeguradoraContratoV1SimulacaoSimulacaoDependenciaCoberturaProduto();
      });

      it('should create an instance of APISeguradoraContratoV1SimulacaoSimulacaoDependenciaCoberturaProduto', function() {
        // TODO: update the code to test APISeguradoraContratoV1SimulacaoSimulacaoDependenciaCoberturaProduto
        expect(instance).to.be.a(Apiseguradora.APISeguradoraContratoV1SimulacaoSimulacaoDependenciaCoberturaProduto);
      });
