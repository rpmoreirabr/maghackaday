...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Apiseguradora.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://apiseguradora-v2.mgaapi.p.azurewebsites.net
     */
    this.basePath = 'https://apiseguradora-v2.mgaapi.p.azurewebsites.net'.replace(/\/+$/, '');
